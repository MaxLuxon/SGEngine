...
#ifndef SGENGINE_PLANE_H
#define SGENGINE_PLANE_H
...
public:
     ...
     */
    inline Plane& operator*=(const Mat4& matrix);
    
    Vec3 getPointOfIntersectionToRay(Vec3 V1, Vec3 V2); // we'll get to this later
