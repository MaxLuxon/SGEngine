...
#ifndef SGENGINE_BOUNDINGBOX_H
#define SGENGINE_BOUNDINGBOX_H

#include "Frustum.h"
#include "SMath.h"

#define COMPLETELY_OUT 0
#define COMPLETELY_IN 1
...
public:
     ...
     */
    bool isEmpty() const;
    bool contains2DPoint(const Vec2& point);
     ...
     */
    inline BoundingBox& operator*=(const Mat4& matrix);
};
