#include "ShaderFormat_GL_ES.h"
#include "ShaderModule.h"

namespace sge {

    ShaderFormat_GL_ES::ShaderFormat_GL_ES(){

        _prefix="#version 120\n";
        _prefix.append("precision mediump float;\n");

    }

    ShaderFormat_GL_ES::~ShaderFormat_GL_ES(){}

    std::string ShaderFormat_GL_ES::getVertexSource(ShaderModule* shaderModule){
...
//        source.append("\n}");
    ...
    std::string ShaderFormat_GL_ES::getFragmentSource(ShaderModule* shaderModule){
